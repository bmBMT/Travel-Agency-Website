...
document.addEventListener("DOMContentLoaded", function () {
    if (document.querySelector("#name_btn")) {
    ...
    if (document.querySelector("#email_btn")) {
    ...
    if (document.querySelector("#password_btn")) {
    ...
    if (document.querySelector("#phone_btn")) {
    ...
    if (document.querySelector("#address_btn")) {
