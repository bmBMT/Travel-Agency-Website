          ...
          <div role="tabpanel" class="tab-pane fade" id="payment">
            ...
            <div class="window">
              <?php
                ...
                {
                  ?>
                  <div class="payCard added_payCard" name="<?php echo mb_substr($payment_data['card_num'], -4, 4) ?>">
                    <div class="payCard_head">
                      ...
                      <div class="deleteCard" name="<?php echo mb_substr($payment_data['card_num'], -4, 4) ?>"><img src="/assets/icons/card-delete.svg"></div>
                    </div>
