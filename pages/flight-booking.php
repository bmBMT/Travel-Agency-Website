    ...
    <div class="col g-40" id="booking-left-content">
      ...
      <?php } else { ?>
        <div class="window" id="bookPayMethod" style="padding: 24px;">
          ...
          <div class="anotherSign_btns" style="flex-direction: column;">
            ...
            <button class="row g-16 btn w-100 jc-center">
              <i class="fa-solid fa-envelope"></i>
              <div class="default-text" style="opacity: 1;">Continue with email</div>
            </button>
          </div>
        </div>
      <?php } ?>
