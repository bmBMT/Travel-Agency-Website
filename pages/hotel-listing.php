                ...
                <?php
                    ...
                    { ?>
                        <div class="logined_elements" id="logined_elements">
                            ...
                            <div class="dropdown">
                                <div class="profile">
                                    <button class="avatar" type="button" id="dropdownMenu2" data-toggle="dropdown"
                                        aria-haspopup="false" aria-expanded="true"
                                        style="background: url(<?= '/' . $_SESSION['user']['avatar'] ?>);">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                                        <div class="column">
                                            <div class="profile">
                                                <div class="avatar"
                                                    style="background: url(<?= '/' . $_SESSION['user']['avatar'] ?>);"></div>
                        ...
                        <div class="bed_input input_filter">
                            <div class="fieldsets">
                                <fieldset class="enterDestination">
                                    ...
                                    <div class="form_content">
                                        <div class="input_group">
                                            ...
                                            <select name="enterDestination_selector" class="selectpicker"
                                                id="bed_input-city" data-live-search="true" data-size="7"
                                                data-display="static" data-dropup-auto="false" required>
                                ...
                                <fieldset class="checkIn">
                                    ...
                                    <div class="form_content">
                                        <div class="input_group">
                                            <input name="checkIn_input" autocomplete="off" type="text"
                                                class="form-control bed_datepicker" id="checkIn_datepicker"
                                                placeholder="Fri 12/2" onkeypress="return false;"
                                ...
                                <fieldset class="checkOut">
                                    ...
                                    <div class="form_content">
                                        <div class="input_group">
                                            <input name="checkOut_input" autocomplete="off" type="text"
                                                class="form-control bed_datepicker" id="checkOut_datepicker"
                                                placeholder="Fri 12/2" onkeypress="return false;"
                                                style="caret-color: transparent !important;" required>
                                            <img src="/assets/icons/calendar_icon.svg" class="form_icon_right">
                                        </div>
                                ...
                                <fieldset class="enterDestination">
                                    ...
                                    <div class="form_content">
                                        <div class="input_group">
                                            ...
                                            <select name="trip_selector" data-dropup-auto="false"
                                                class="selectpicker trip_select">
      ...
      <div class="filter">
        ...
        <div class="filter-input" id="freebies">
          <nav class="fold">
            ...
            <button class="toggler collapsed" type="button" data-toggle="collapse" data-target="#freebiesCheckbox" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
              <i class="fa fa-chevron-up"></i>
            </button>
          </nav>
        ...
        <div class="filter-input" id="amenities">
          <nav class="fold">
            ...
            <button class="toggler collapsed" type="button" data-toggle="collapse" data-target="#amenitiesCheckbox" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
              <i class="fa fa-chevron-up"></i>
            </button>
          </nav>
