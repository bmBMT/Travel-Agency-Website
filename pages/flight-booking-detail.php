...
<body id="flight">
  ...
  <div class="detail-content container" style="gap: 40px;">
    <div class="row al-center w-100">
      <div class="col g-16">
        <div class="row g-16 text-title">Emirates A380 Airbus</div>
      ...
      <div class="col g-16" id="airplane-btns">
        <div id="airplane-price" style="color: #112211;">$265</div>
      ...
      <div class="download-ticket">
        <div class="ticket">
          <div class="date-time-info">
            <div class="col g-4">
              <div class="date-time-title">12:00 pm</div>
              <div class="date-time-about">Newark(EWR)</div>
            </div>
            <div class="col g-8 al-center">
              <img src="/assets/icons/ticket_arrow.svg" style="transform: rotateX(180deg);">
              <img class="date-time-icon" src="/assets/icons/black_airplane_icon.svg" style="transform: rotateZ(90deg);">
              ...
              <div class="ticket-head">
                <div class="row g-16 al-center" id="user">
                  ...
                  <div class="col">
                    ...
                    <div class="payTotal-text">Boarding Pass N’123</div>
                  </div>
                </div>
                <div class="ticket-head-text">Busniess Class</div>
              </div>
        ...
        <div class="secondInfo-ticket">
          <div class="card-window window" id="first-card">
            <div class="card-polygon"></div>
            <img src="/assets/imgs/trip_cards/Istanbul, Turkey.svg" alt="">
            <div class="col">
              <div class="card-window-title">James Doe</div>
              <div class="card-window-text">Boarding Pass N’123</div>
            </div>
          </div>
          <div class="card-window window" id="second-card">
            <div class="card-polygon"></div>
            <img src="/assets/imgs/trip_cards/Istanbul, Turkey.svg" alt="">
            <div class="col">
              <div class="card-window-title">James Doe</div>
